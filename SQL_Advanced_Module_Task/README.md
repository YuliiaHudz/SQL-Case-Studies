...
The SQL code for this task is located in the file [**SQL_Advanced_Module_Task.sql**](SQL-Case-Studies/SQL_Advanced_Module_Task/SQL_Advanced_Module_Task.sql) This file contains the SQL query that performs the analysis.
